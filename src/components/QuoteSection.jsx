      ...
      <div className="">
          ...
          <div className="h-full flex flex-col justify-center">
            <div className="container mx-auto px-6 text-center text-white">
              <div className="text-right">
                <p className="text-gray-700 text-lg text-justify ml-auto w-[600px]">"{t('quotes.p1')}"</p>
        ...
        <div className="h-full md:h-[720px] bg-cover bg-center" style={{ backgroundImage: "url('/images/4.png')" }}>
          <div className="h-full flex flex-col justify-center">
            <div className="container mx-auto px-6 text-center text-white">
              <div className="text-right">
                <p className="text-gray-700 text-lg text-justify ml-auto w-[600px]">"{t('quotes.p2')}"</p>
        ...
        <div className="h-full md:h-[720px] bg-cover bg-center" style={{ backgroundImage: "url('/images/5.png')" }}>
          <div className="h-full flex flex-col justify-center">
            <div className="container mx-auto px-6 text-center text-white">
              <div className="text-right">
                <p className="text-gray-700 text-lg text-justify ml-auto w-[600px]">"{t('quotes.p3')}"</p>
